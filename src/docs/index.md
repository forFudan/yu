...
我根据纲络社区八亿字频语料制作了「宇浩极简千词词库」。其中共有高频词语一千个，约覆盖 20% 的文字。宇浩输入法的最佳输入体验，是以字为主，以词为辅，激进打字，谨慎打词。输入时，只打极简千词、单字、用户自定词。从而达到较佳的确定性，做到完全关闭候选框输入。关于「宇浩极简千词词库」，[请参阅此页面](../learn/lexicon.md)。
