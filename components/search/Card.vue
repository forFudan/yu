...
const codes = computed(() => makeCodesFromDivision(p.chaifen.division, p.zigenMap))
...
<template>
    <div
        class="group border p-3 m-2 rounded-3xl shadow-md zigen-font text-center bg-gray-50 dark:bg-slate-900">
        ...
        <div class="invisible group-hover:visible">
            <div class="flex justify-center dark:opacity-55 opacity-100">
                ...
                <a :href="'https://ctext.org/dictionary.pl?if=gb&char=' + uriText" class="" target="_blank" rel="noreferrer"
                    title="中國哲學書電子化計劃查询">
