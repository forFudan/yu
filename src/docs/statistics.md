...
以下为单字全码的结果。表格按输入法的性质排列。部分输入法依照作者要求不予展示。
...
| 易码·26键     |        77.73 |       112.56 |        91.96 |
| 吉旦饼·26键   |        77.22 |        76.34 |        76.78 |
