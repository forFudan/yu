...
一般而言，表現漢字輸入法的關係，用的是樹狀圖，主要展示輸入法的衍化和傳承。如縴夫張會製的[中文輸入法樹狀關係圖](https://zhuanlan.zhihu.com/p/710122624)。
...
表格按輸入法發佈時間排序，可以更加有效地看出新輸入法借鑒老輸入法的情況。每行的最大值，基本和縴夫張會製的[中文輸入法樹狀關係圖](https://zhuanlan.zhihu.com/p/710122624)中顯示的繼承關係一致。
