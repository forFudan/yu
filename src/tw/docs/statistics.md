...
<!-- 單字一簡出簡不出全數據。也就是說，有一簡的單字，全碼在詞語全碼之後。

| 方案       | 簡體詞語完美動態選重率 | 繁體詞語完美動態選重率 | 繁簡混合詞語完美動態選重率 |
| :--------- | ---------------------: | ---------------------: | -------------------------: |
| 五筆 86     |                 222.1‱ |                 242.4‱ |                     780.2‱ |
| 藍寶石     |                  53.5‱ |                 106.7‱ |                     221.8‱ |
| 徐碼 23     |                 123.1‱ |                 159.4‱ |                     351.1‱ |
...
以下為一級簡碼出簡不出全的結果，換句話說，如果一個字存在一級簡碼，則默認只打簡碼，並將其全碼後置。

| 方案          | 毛澤東選集（簡） | 天龍八部（簡） | 三體三部曲（簡） | 戰爭與和平（簡） |
| :------------ | -------------: | -----------: | -------------: | -------------: |
| 五筆 86        |          25.8‱ |        30.6‱ |          25.7‱ |          20.9‱ |
| 藍寶石        |          18.1‱ |        13.8‱ |          24.6‱ |          17.5‱ |
| 鄭碼          |          39.5‱ |        41.5‱ |          45.8‱ |          43.1‱ |
| 真碼          |           1.1‱ |         3.0‱ |           2.1‱ |           2.1‱ |
| 徐碼 23        |           3.3‱ |         9.8‱ |           7.0‱ |           7.8‱ |
| 宇浩·簡體簡碼 |           1.2‱ |         2.8‱ |           2.7‱ |           2.4‱ |
...
| 方案          | 論語集解（繁簡混） | 三國演義（繁簡混） | 海上花列傳（繁簡混） |
| :------------ | ---------------: | ---------------: | -----------------: |
| 五筆 86        |           260.8‱ |           360.8‱ |             243.5‱ |
| 藍寶石        |            20.5‱ |            52.1‱ |              34.0‱ |
| 鄭碼          |           263.3‱ |           416.2‱ |             339.4‱ |
| 真碼          |           290.1‱ |           405.0‱ |             331.9‱ |
| 徐碼 23        |             9.8‱ |            39.1‱ |              22.5‱ |
| 宇浩·簡體簡碼 |             4.4‱ |            24.5‱ |               9.6‱ |
...
上表反映的是確定性，而平均碼長則反映輸入效率。現統計如下。

| 方案          | 簡體均值 | 毛澤東選集（簡） | 天龍八部（簡） | 三體（簡） | 戰爭與和平（簡） | 史記（繁） | 紅樓夢（繁） | 笑傲江湖（繁） | 論語集解（繁簡混） |
| :------------ | -------: | -------------: | -----------: | -------: | -------------: | -------: | ---------: | -----------: |
| 徐碼 23        |     3.47 |           3.46 |          3.5 |     3.48 |           3.46 |     3.63 |       3.46 |         3.49 | 3.54             |
| 四碼吉旦餅    |     3.48 |           3.52 |         3.46 |     3.47 |           3.45 |     3.63 |       3.46 |         3.46 | 3.54             |
| 真碼          |      3.5 |           3.47 |         3.54 |     3.47 |           3.53 |     3.66 |       3.57 |         3.56 | 3.63             |
| 鄭碼          |     3.52 |           3.51 |         3.58 |     3.49 |           3.51 |     3.71 |       3.61 |         3.63 | 3.66             |
| 藍寶石        |     3.58 |            3.6 |          3.6 |     3.57 |           3.54 |     3.85 |       3.62 |         3.63 | 3.8              |
| 五筆 86        |     3.59 |            3.5 |         3.67 |     3.59 |           3.61 |     3.87 |       3.68 |          3.7 | 3.83             |
| 宇浩·簡體簡碼 |      3.6 |           3.62 |         3.61 |     3.57 |           3.59 |     3.88 |       3.64 |         3.65 | 3.82             |
