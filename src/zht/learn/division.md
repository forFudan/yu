...
注意到，爲了使字根數量少，某些大於等於兩劃的字根，它的筆順可能會被另一個或多個字根打斷。我們要使得不被打斷的大於等於兩劃的字根數量更多、筆劃更多。即滿足「筆順連續」[^order]。
...
`单`可以拆成`丷日十`也可以拆成`丷冂丰`。兩者都是三根，都完全「符合筆順」。因爲包圍結構不拆散，故而`单`拆成`丷日十`。
<div class="flex justify-left flex-wrap">
<Chaifen char='单' :parts='[2,4,2]' />
✅
<Chaifen char='单' :parts='[2,2,4]' />
...
`免`可以拆成`⺈口儿`也可以拆成`⺈冂尢`。兩者都是三根，都完全「符合筆順」。因爲包圍結構不拆散，故而`免`拆成`⺈口儿`。
<div class="flex justify-left flex-wrap">
