...
我根據綱絡社區八億字頻語料製作了「宇浩極簡千詞詞庫」。其中共有高頻詞語一千個，約覆蓋 20% 的文字。宇浩輸入法的最佳輸入體驗，是以字爲主，以詞爲輔，激進打字，謹慎打詞。輸入時，只打極簡千詞、單字、用户自定詞。從而達到較佳的確定性，做到完全關閉候選框輸入。關於「宇浩極簡千詞詞庫」，[請參閲此頁面](../learn/lexicon.md)。
